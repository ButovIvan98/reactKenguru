    ...
    return <div className={'container-fluid'}>
        <div className={'container'}>
            <div className={'row'}>
                ...
                <div className={'col-12'}>
                    <NavLink className={classes.navLink} to={'/score/1'}>
                        <div className={'row mb-3 mt-3 ' + ' ' + classes.listOrder}>
                            ...
                            <div className={'col-lg-3 mb-lg-0 mb-3 col-12' + ' ' + classes.cityIn}>
                                ...
                                {/*<p className={classes.statusOrder} style={{color: 'red'}}>{list.status}</p>*/}
                            </div>
