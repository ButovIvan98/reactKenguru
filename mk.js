                ...
                <div className={'col-3'}>
                    <div className={'row'}>
                        <div className="col-12 mt-5 text-center">
                            <img src={'https://avatars.mds.yandex.net/get-pdb/69339/203472834-portret-v-profil-1457607709.14/s1200'} className={classes.imgManager}/>
                        </div>
                        <div className={'col-12 text-center'}>
                            <p className={classes.nameManager}>
                                Великосельских Максим
                            </p>
                        </div>
                    </div>
                </div>
